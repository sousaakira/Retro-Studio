...
#define HAVE_toggle_pr (TARGET_SH4A_FP || TARGET_FPU_SH4_300)
...
#define HAVE_negsf2_no_fpscr (TARGET_FPU_ANY && !TARGET_FPU_SH4_300)
#define HAVE_negsf2_fpscr (TARGET_FPU_SH4_300)
...
#define HAVE_abssf2_no_fpscr (TARGET_FPU_ANY && !TARGET_FPU_SH4_300)
#define HAVE_abssf2_fpscr (TARGET_FPU_SH4_300)
...
#define HAVE_negdf2_fpscr (TARGET_FPU_SH4_300)
#define HAVE_negdf2_no_fpscr (TARGET_FPU_DOUBLE && !TARGET_FPU_SH4_300)
#define HAVE_sqrtdf2_i (TARGET_FPU_DOUBLE)
#define HAVE_absdf2_no_fpscr (TARGET_FPU_DOUBLE && !TARGET_FPU_SH4_300)
#define HAVE_absdf2_fpscr (TARGET_FPU_SH4_300)
...
#define HAVE_cpymemsi (TARGET_SH1)
...
extern rtx        gen_negsf2_no_fpscr                      (rtx, rtx);
extern rtx        gen_negsf2_fpscr                         (rtx, rtx);
extern rtx        gen_sqrtsf2_i                            (rtx, rtx);
extern rtx        gen_rsqrtsf2                             (rtx, rtx);
extern rtx        gen_fsca                                 (rtx, rtx, rtx);
extern rtx        gen_abssf2_no_fpscr                      (rtx, rtx);
extern rtx        gen_abssf2_fpscr                         (rtx, rtx);
...
extern rtx        gen_negdf2_fpscr                         (rtx, rtx);
extern rtx        gen_negdf2_no_fpscr                      (rtx, rtx);
extern rtx        gen_sqrtdf2_i                            (rtx, rtx);
extern rtx        gen_absdf2_no_fpscr                      (rtx, rtx);
extern rtx        gen_absdf2_fpscr                         (rtx, rtx);
