...
enum opt_code
{
  ...
  OPT_m2 = 1885,                             /* -m2 */
  OPT_m2a = 1886,                            /* -m2a */
  OPT_m2a_nofpu = 1887,                      /* -m2a-nofpu */
  OPT_m2a_single = 1888,                     /* -m2a-single */
  OPT_m2a_single_only = 1889,                /* -m2a-single-only */
  OPT_m2e = 1890,                            /* -m2e */
  OPT_m3 = 1891,                             /* -m3 */
  OPT_m3e = 1892,                            /* -m3e */
  OPT_m4 = 1893,                             /* -m4 */
  OPT_m4_100 = 1894,                         /* -m4-100 */
  OPT_m4_100_nofpu = 1895,                   /* -m4-100-nofpu */
  OPT_m4_100_single = 1896,                  /* -m4-100-single */
  OPT_m4_100_single_only = 1897,             /* -m4-100-single-only */
  OPT_m4_200 = 1898,                         /* -m4-200 */
  OPT_m4_200_nofpu = 1899,                   /* -m4-200-nofpu */
  OPT_m4_200_single = 1900,                  /* -m4-200-single */
  OPT_m4_200_single_only = 1901,             /* -m4-200-single-only */
  OPT_m4_300 = 1902,                         /* -m4-300 */
  OPT_m4_300_nofpu = 1903,                   /* -m4-300-nofpu */
  OPT_m4_300_single = 1904,                  /* -m4-300-single */
  OPT_m4_300_single_only = 1905,             /* -m4-300-single-only */
  OPT_m4_340 = 1906,                         /* -m4-340 */
  OPT_m4_400 = 1907,                         /* -m4-400 */
  OPT_m4_500 = 1908,                         /* -m4-500 */
  OPT_m4_nofpu = 1909,                       /* -m4-nofpu */
  OPT_m4_single = 1910,                      /* -m4-single */
  OPT_m4_single_only = 1911,                 /* -m4-single-only */
  OPT_m4a = 1912,                            /* -m4a */
  OPT_m4a_nofpu = 1913,                      /* -m4a-nofpu */
  OPT_m4a_single = 1914,                     /* -m4a-single */
  OPT_m4a_single_only = 1915,                /* -m4a-single-only */
  OPT_m4al = 1916,                           /* -m4al */
  OPT_maccumulate_outgoing_args = 1917,      /* -maccumulate-outgoing-args */
  OPT_matomic_model_ = 1918,                 /* -matomic-model= */
  OPT_mb = 1919,                             /* -mb */
  OPT_mbigtable = 1920,                      /* -mbigtable */
  OPT_mbitops = 1921,                        /* -mbitops */
  OPT_mbranch_cost_ = 1922,                  /* -mbranch-cost= */
  OPT_mcbranch_force_delay_slot = 1923,      /* -mcbranch-force-delay-slot */
  OPT_mdalign = 1924,                        /* -mdalign */
  OPT_mdiv_ = 1925,                          /* -mdiv= */
  OPT_mdivsi3_libfunc_ = 1926,               /* -mdivsi3_libfunc= */
  OPT_mfdpic = 1927,                         /* -mfdpic */
  OPT_mfixed_range_ = 1928,                  /* -mfixed-range= */
  OPT_mfmovd = 1929,                         /* -mfmovd */
  OPT_mfsca = 1930,                          /* -mfsca */
  OPT_mfsrra = 1931,                         /* -mfsrra */
  /* OPT_mfused_madd = 1932, */              /* -mfused-madd */
  OPT_mhitachi = 1933,                       /* -mhitachi */
  OPT_mieee = 1934,                          /* -mieee */
  OPT_minline_ic_invalidate = 1935,          /* -minline-ic_invalidate */
  OPT_misize = 1936,                         /* -misize */
  OPT_ml = 1937,                             /* -ml */
  OPT_mlra = 1938,                           /* -mlra */
  OPT_mnomacsave = 1939,                     /* -mnomacsave */
  OPT_mpadstruct = 1940,                     /* -mpadstruct */
  OPT_mprefergot = 1941,                     /* -mprefergot */
  OPT_mpretend_cmove = 1942,                 /* -mpretend-cmove */
  OPT_mrelax = 1943,                         /* -mrelax */
  OPT_mrenesas = 1944,                       /* -mrenesas */
  OPT_mtas = 1945,                           /* -mtas */
  OPT_multcost_ = 1946,                      /* -multcost= */
  OPT_musermode = 1947,                      /* -musermode */
  OPT_mzdcbranch = 1948,                     /* -mzdcbranch */
  OPT_n = 1949,                              /* -n */
