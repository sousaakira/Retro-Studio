...
#define HAVE_ATTR_endian 1
extern enum attr_endian get_attr_endian (void);

#define HAVE_ATTR_fpu_single 1
extern enum attr_fpu_single get_attr_fpu_single (void);

#define HAVE_ATTR_fmovd 1
extern enum attr_fmovd get_attr_fmovd (void);

#define HAVE_ATTR_pipe_model 1
extern enum attr_pipe_model get_attr_pipe_model (void);

#define HAVE_ATTR_type 1
extern enum attr_type get_attr_type (rtx_insn *);

#define HAVE_ATTR_insn_class 1
extern enum attr_insn_class get_attr_insn_class (rtx_insn *);

#define HAVE_ATTR_fp_mode 1
extern enum attr_fp_mode get_attr_fp_mode (rtx_insn *);

#define HAVE_ATTR_fp_set 1
extern enum attr_fp_set get_attr_fp_set (rtx_insn *);

#define HAVE_ATTR_short_cbranch_p 1
extern enum attr_short_cbranch_p get_attr_short_cbranch_p (rtx_insn *);

#define HAVE_ATTR_med_branch_p 1
extern enum attr_med_branch_p get_attr_med_branch_p (rtx_insn *);

#define HAVE_ATTR_med_cbranch_p 1
extern enum attr_med_cbranch_p get_attr_med_cbranch_p (rtx_insn *);

#define HAVE_ATTR_braf_branch_p 1
extern enum attr_braf_branch_p get_attr_braf_branch_p (rtx_insn *);

#define HAVE_ATTR_braf_cbranch_p 1
extern enum attr_braf_cbranch_p get_attr_braf_cbranch_p (rtx_insn *);
...
#define HAVE_ATTR_needs_delay_slot 1
extern enum attr_needs_delay_slot get_attr_needs_delay_slot (rtx_insn *);

#define HAVE_ATTR_banked 1
extern enum attr_banked get_attr_banked (rtx_insn *);

#define HAVE_ATTR_hit_stack 1
extern enum attr_hit_stack get_attr_hit_stack (rtx_insn *);

#define HAVE_ATTR_interrupt_function 1
extern enum attr_interrupt_function get_attr_interrupt_function (void);

#define HAVE_ATTR_in_delay_slot 1
extern enum attr_in_delay_slot get_attr_in_delay_slot (rtx_insn *);

#define HAVE_ATTR_cond_delay_slot 1
extern enum attr_cond_delay_slot get_attr_cond_delay_slot (rtx_insn *);

#define HAVE_ATTR_is_sfunc 1
extern int get_attr_is_sfunc (rtx_insn *);
#define HAVE_ATTR_dfp_comp 1
extern enum attr_dfp_comp get_attr_dfp_comp (rtx_insn *);

#define HAVE_ATTR_late_fp_use 1
extern enum attr_late_fp_use get_attr_late_fp_use (rtx_insn *);

#define HAVE_ATTR_any_fp_comp 1
extern enum attr_any_fp_comp get_attr_any_fp_comp (rtx_insn *);

#define HAVE_ATTR_any_int_load 1
extern enum attr_any_int_load get_attr_any_int_load (rtx_insn *);

#define HAVE_ATTR_highpart 1
extern enum attr_highpart get_attr_highpart (rtx_insn *);
